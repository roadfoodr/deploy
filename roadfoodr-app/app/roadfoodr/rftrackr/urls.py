...
from rftrackr.views import FoliumView
...
urlpatterns = [
    ...
    path('map', FoliumView.as_view(template_name='map.html'), name='map'),
    ...
    path('recordUser', views_api.api_record_user, name='Record visitor stats'),
